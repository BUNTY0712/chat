...
import OnlineStatus from "./smallComponent/OnlineStatus";
...
const SingleUserMessage = () => {
  ...
  const handleToggle = (id, mess) => {
    ...
    setReplyId(id);
    // dispatch(setToggle((prevToggle) => !prevToggle));
    // dispatch(setToggle("replyon"));
    if (toggle == "replyon") {
    ...
    setTimeout(() => {
      ...
      if (onlinestatus == 0) {
        const userConfirmation = window.confirm(
          "This Person is offline So, Do you want to send this message to WhatsApp? If yes, click OK."
        );
  ...
  return (
    <>
      <Grid className="singleusermessage-box" item lg={8.9} mx="auto">
          ...
          <Box>
            <Box className="flex-space-between">
              ...
              <Box className="sum-input-search">
                <Box className="sum-input-search-box" mt={1} mr={5}>
            ...
            {messChange == "one" ? (
              <Box
                onClick={() => dispatch(setMedia(false))}
                mt={1}
                className="box-style"
                ref={containerRef}
                sx={{ height: "68.5vh", overflowY: "scroll" }}
                onScroll={(e) => {
              ...
              >
                    ...
                    (filterstatus
                      ...
                      return (
                        <React.Fragment key={index}>
                          ...
                          {item.id === sel_messId && toggle == "replyon" ? (
                          ...
                          >
                            <Box>
                              <Grid container>
                                <Grid className="msgBox" item xs={12} lg={10}>
                                  <Box className="msgBox" alignItems="center">
                ...
                {sel_messId == null && toggle == "replyon" ? (
                ...
                <Box mt={0.1} ml={2}>
                  <div>
                    <div className="dropdown">
                      ...
                      <ul
                        className="dropdown-menu sum-dropdown-ul"
                        aria-labelledby="dropdownMenuButton1"
                      >
                        <li className="sum-dropdown-li">
                          <label htmlFor="image">
